...
fetchAllvehicleMakes(){
 this.http.get('https://52.16.69.88/makes').subscribe({
  next:(res:any)=>{
...
fetchAllModelByMake(make:string){
  this.http.get(`https://52.16.69.88/models/${make}`).subscribe({
   next:(res:any)=>{
     console.log("success:",res)
 ...
 fetchEngine(){
  this.http.get(`https://52.16.69.88/engines/${this.selectedMake}/${this.selectedModel}`).subscribe({
   next:(res:any)=>{
     console.log("success:",res)
 ...
 fetchYears(){
  this.http.get(`https://52.16.69.88/years/${this.selectedMake}/${this.selectedModel}`).subscribe({
   next:(res:any)=>{
     console.log("success:",res)
 ...
 fetchDetails(){
  this.http.get(`https://52.16.69.88/vehicle/${this.selectedMake}/${this.selectedModel}/${this.selectedEngine}/${this.selectedYear}`).subscribe({
   next:(res:any)=>{
     console.log("success:",res)
 ...
 fetchDetailsByVin(vin:any){
  this.http.get(`https://52.16.69.88/vehicle/vin/${vin}`).subscribe({
   next:(res:any)=>{
     console.log("success:",res)
 ...
 fetchPurchaseDetailsWithVin(vin:any){
  this.http.get(`https://52.16.69.88/hunter/vin/${vin}`).subscribe({
   next:(res:any)=>{
     console.log("success:",res)
